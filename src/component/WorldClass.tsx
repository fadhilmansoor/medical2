...
import { worldclasslistdata as defaultList, type WorldClassItem } from "../constant/alldata";

type Props = {
  items?: WorldClassItem[]; // ✅ optional (for service detail)
};

function WorldClass({ items }: Props) {
  // ✅ use dynamic list if provided, otherwise fallback to default list
        ...
        <div className="col-xl-6 m-b30">
          <div className="section-head style-1 m-b30">
            ...
            >
              ...
              unparalleled expertise, providing a comfortable and effective path to
              optimal health.
            </p>
          </div>
