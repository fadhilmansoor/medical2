...
export const serviceboxdata: ServiceItem[] = [
  {
    ...
    title: "Weight Loss",
    slug: "weight-loss",
    description: "Expert care for real, lasting results. Lose weight the right way.",
    delay: "0.2s",
    icon: Scale,
...

  {
    ...
    description: "Natural looks, confident results. Crafted by expert surgeons",
    delay: "0.4s",
    icon: Scissors,
    services: [
...

  {
    ...
    title: "Derma",
    slug: "derma",
    description: "Fuller hair, permanent growth. Restore your look with precision.",
    delay: "0.6s",
    icon: Sparkles,
    services: [
      "Body filler",
...

  {
    ...
    slug: "hair-treatment",
    description: "Glow brighter, age beautifully. Advanced skin care, redefined.",
    delay: "0.8s",
    icon: Droplets,
